...
export default function SeriesCard({ serial }: { serial: MovieCardData; size?: "sm" | "md" | "lg" }) {
  ...
  return <Link href={`/serial/${serial.slug}`} className="group relative block aspect-[16/8.5] w-[calc(100vw-32px)] shrink-0 overflow-hidden rounded-xl border border-white/15 bg-[#111315] transition-colors hover:border-amber-400/45 sm:w-[430px] lg:w-[calc((min(100vw,1400px)-96px)/3)]" style={{ scrollSnapAlign: "start" }}>
