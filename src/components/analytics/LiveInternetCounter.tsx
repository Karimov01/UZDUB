...
export default function LiveInternetCounter() {
  ...
  return (
    <a href="https://www.liveinternet.ru/click" target="_blank" rel="noopener noreferrer" aria-label="LiveInternet statistikasi">
      ...
      <img id="licnt6E5C" width="88" height="31" className="opacity-70 hover:opacity-100 transition-opacity" style={{ border: 0 }} alt="LiveInternet" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAEALAAAAAABAAEAAAIBTAA7" />
    </a>
  );
}
