...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="uz" className={`h-full ${inter.variable} ${spaceGrotesk.variable}`}><body className="min-h-full antialiased flex flex-col"><JsonLd data={siteJsonLd} /><ConditionalLayout>{children}</ConditionalLayout><VisitorTracker /><Analytics /></body></html>;
}
